# Домашнее задание к занятию "Система мониторинга Zabbix" - Сергеев Алексей
...
Использованные команды:
   ...
   - sudo nano /etc/zabbix/zabbix_server.conf (Изменили пароль для DB)
   - systemctl restart zabbix-server apache2
   - systemctl enable zabbix-server apache2

![Панель мониторинга Zabbix](https://github.com/DeFranS325/sys-pattern-homework/blob/9-01/img/1-1.png)
