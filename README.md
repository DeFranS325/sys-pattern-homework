# Домашнее задание к занятию «Система мониторинга Prometheus» - Сергеев Алексей
...
### Ответ 1
![Prometheus Status](https://github.com/DeFranS325/sys-pattern-homework/blob/9-04/img/1-1.png)
...
### Ответ 4
![Grafana](https://github.com/DeFranS325/sys-pattern-homework/blob/9-04/img/4-1.png)
